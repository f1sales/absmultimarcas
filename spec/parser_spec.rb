...
RSpec.describe F1SalesCustom::Email::Parser do
  context 'when came from the website' do
    let(:email) do
      ...
      email.body = "Formulário de Proposta de Veículo\n*Nome Completo:* Teste Lead Site ABS MULTIMARCAS\n*Email:* Absmultimarcassjc@gmail.com\n*Telefone:* (13) 9313-13131\n*Celular:* (19) 9969-28688\n*Melhor forma de iniciar a negociacao:*\nTrocar_meu_veículo_por_um_novo_e_ainda_receber_um_valor_em_dinheiro\n*Mensagem:* Agora vai funcionar direitinho...\n*Marca:* RENAULT\n*Modelo:* LOGAN\n*Ano:* 2019/2020\n*Versao:* 1.0 12V SCE FLEX LIFE MANUAL\n*Preco:* 53.900,00\n*Cambio:* Manual\n*Portas:* 4\n*Combustivel:* Gasolina e álcool\n*Km:* 45.127\n*Final da Placa:* 2\n*Opcionais:* Ar condicionado, Travas elétricas, Vidros elétricos, Freio\nABS, Air bag do motorista, Desembaçador traseiro, Air bag duplo, Ar quente,\nEncosto de cabeça traseiro, Direção Elétrica, Distribuição eletrônica de\nfrenagem, Pára-choques na cor do veículo\n*Observacoes Adicionais:* ?Com uma vasta gama de veículos em estoque, a ABS\nMULTIMARCAS tem opções para todos os gostos. Ajudamos os clientes a\nencontrar os melhores veículos do mercado desde 2000. Está procurando um\nRENAULT LOGAN 1.0 12V SCE FLEX LIFE MANUAL? Nossa equipe está pronta para\nauxiliar você em todas as etapas do processo.\n*Loja:* ABS MULTIMARCAS\n*Url do Site:* https://www.absmultimarcas.com.br\n*Url do Formulário:*\nhttps://www.absmultimarcas.com.br/estoque/veiculo/27913322/renault_logan_1.0-12v-sce-flex-life-manual"
